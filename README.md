...
Drop new files into the `images/` folder, then reference them in `index.html` with a relative path, e.g.:

```html
<img src="images/your-photo.jpg" alt="Description of the room">
```

Relative paths work the same locally and once deployed to GitHub Pages, as long as `images/` stays in the same folder as `index.html`.
